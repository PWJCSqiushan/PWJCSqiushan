...
<p align="center">
  <a href="#featured-work"><img alt="Featured work" src="https://img.shields.io/badge/Featured_Work-View_projects-AF85B9?style=for-the-badge"></a>
  <a href="#tech-stack"><img alt="Tech stack" src="https://img.shields.io/badge/Tech_Stack-Tools_&_Stack-668099?style=for-the-badge"></a>
  <a href="#github-data"><img alt="GitHub data" src="https://img.shields.io/badge/GitHub_Data-Live-CFA2B0?style=for-the-badge"></a>
  <a href="https://github.com/PWJCSqiushan/PWJCSqiushan/issues/new?template=say-hello.yml"><img alt="Say hello" src="https://img.shields.io/badge/Say_Hello-Start_a_conversation-8D6A9F?style=for-the-badge"></a>
</p>
...
|:---|:---|:---|
| AI applications, computer vision, full-stack products, embedded interaction | Event and portrait photography, post-production workflows, creator tools | Road and trail running, training plans, data-informed review |
...
A local-first AI batch post-production workstation for fursuit event photography. The project comes directly from real delivery needs and integrates culling, human-face privacy review, reference-guided base grading, eye enhancement, watermarking, manual quality control, and final delivery.

- <code>Python</code> <code>FastAPI</code> <code>OpenCV</code> <code>YuNet</code> <code>Computer Vision</code>
- Processes real photographs locally to reduce privacy risks in commercial photography
- Accumulates human feedback through an analyse → review → train → re-analyse loop
- Continues to improve white balance, subject exposure, local masks, and multi-user deployment
...
A local intelligent voice interaction assistant. The desktop application handles recording, speech recognition, agent calls, and speech synthesis, while an external ESP32-S3 circular AMOLED display presents expressive states.

- <code>Python</code> <code>C++</code> <code>ESP32-S3</code> <code>STT / TTS</code> <code>AI Agent</code>
- Supports local agents, API services, and command-line fallbacks
- Integrates the desktop voice pipeline, serial communication, and embedded display into one system
- Continues to explore more natural and reliable human-computer interaction

[View the architecture, hardware, and quick start →](https://github.com/PWJCSqiushan/JKS#readme)
...
| [hospital-management-system](https://github.com/PWJCSqiushan/hospital-management-system) | A C/C++ course project implementing a complete outpatient workflow |
...
| [cloudflare-edgetunnel-v2rayn-guide](https://github.com/PWJCSqiushan/cloudflare-edgetunnel-v2rayn-guide) | A network configuration guide based on real deployment and troubleshooting work |
...
- **Projects:** improving the stability, user experience, and deployment of existing projects
- **AI research:** exploring broader work in sound recognition and computer vision while building more intelligent-system engineering experience
- **Foundations:** studying C++ competitive programming, algorithms, computer systems, and mathematical modelling
- **Visual work:** continuing event, portrait, and video production while improving Lightroom, Photoshop, and DaVinci Resolve workflows
- **Running:** combining training data, periodisation, and structured reviews to make long-distance training more scientific and precise

<a name="tech-stack"></a>

## Tech Stack & Tools

This section combines technologies already used in projects with areas I am currently studying and strengthening.
...
If you are interested in **AI and imaging, creator tools, voice interaction, or open-source collaboration**, feel free to:

- [Leave a public note or collaboration idea](https://github.com/PWJCSqiushan/PWJCSqiushan/issues/new?template=say-hello.yml)
- [Browse all repositories](https://github.com/PWJCSqiushan?tab=repositories)
- [Send an email](mailto:dongzongyue@gmail.com)
